...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='E:/Research-code/Spoon-yolo/flexible-yolov5-main/runs/train/exp21/weights/best.pt', help='model.pt path(s)')
