...
class Detector(object):
    def __init__(self, pt_path, namesfile, img_size, conf_thres=0.1, iou_thres=0.1, classes=0, agnostic_nms=False,
    ...
    def detect_image(self, image):
        ...
        # img = cv2.cvtColor(img, cv2.COLOR_BGR2HSV).transpose(2, 0, 1)  # 转换成HSV
        ...
        ret = self.model(img)
        pred = ret[0]
        # image = cv2.imread('E:/python_project/flexible-yolov5-main/datasets/images/cam0_20210807095057_000046_0.jpg')

        show_CAM("E:/Research-code/Spoon-yolo/flexible-yolov5-main/runs/Att_visual", image, ret[1], 0, 1 + 5, image_size=(640, 640), normalization=True)
...
if __name__ == '__main__':
    ...
    pt_path = 'E:/Research-code/Spoon-yolo/flexible-yolov5-main/result//weights/best.pt'  # 模型文件
    name_path = 'E:/Research-code/Spoon-yolo/flexible-yolov5-main/configs/coco_names.txt'  # 类名文件
    imgs_root = 'E:/Research-code/Spoon-yolo/flexible-yolov5-main/datasets/images'  # 测试图片根目录
    save_dir = 'E:/Research-code/Spoon-yolo/flexible-yolov5-main/runs/detect'  # 测试结果保存根目录

    model = Detector(pt_path, name_path, 640, xcycwh=False)
