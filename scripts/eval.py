...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='E:/python_project/flexible-yolov5-main/result/训练集测试集相同/yolov5-lbp-att-hsv-1000/weights/best.py', help='model.pt path(s)')
    ...
    parser.add_argument('--save-hybrid', action='store_false', help='save label+prediction hybrid results to *.txt')
